...
function newCapture() {
	...
	if (capFormvalue.capAnalyse.length ==0){		
		textError.setContent("Enter a type of Analyse");
		myError.show();
		return;
	}
	...
	"&capAnalyse="+capFormvalue.capAnalyse;
//	console.log(url_insert);
//./manageData.pl option=Newcapture capture=name capVs=ver capVs=ver capDes=des capFile=dsds capType=dsdszzz capAnalyse=dsdsxxx
	sendData(url_insert);
	refreshCaptureList();
};
